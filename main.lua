-- ====================================================================
-- AR SCRIPT HUB - OFFICIAL VERSION v5.6 (LAYOUT SLIDER FIXED)
-- ====================================================================
...
-- ====================================================================
-- PEMBARUAN: KOMPONEN SLIDER GENUINE (ANTI TULISAN "BUTTON" + KOTAK KANAN)
-- ====================================================================
local function createLevelControl(parent, labelText, defaultLvl, min, max, callback)
    ...
    -- KOTAK INDIKATOR LEVEL (Ditaruh di sebelah kanan atas slider)
    ...
    -- KNOB BULATAN MURNI FRAME (Mencegah teks bawaan "Button")
    ...
    -- TRIGGER AREA SENTUH PAKE IMAGEBUTTON TRANSPARAN 100% (ANTI TEXT ELEMENT)
    ...
    local function update(input)
        ...
        valLabel.Text = tostring(val) -- Isi level ngikut pergeseran slider secara real-time
        callback(val)
    end
...
print("[AR SCRIPT HUB]: Genuine Slider Applied and Layout Fixed Successfully!")
